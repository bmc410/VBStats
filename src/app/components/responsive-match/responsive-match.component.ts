...
import { CourtPosition, PlayerWithId, GameWithId, gameMatch, TeamWithId, Stat, statEntry, GameScore, StatNib } from 'src/app/models/appModels';
...
@Component({
  selector: 'app-responsive-match',
  templateUrl: './responsive-match.component.html',
  styleUrls: ['./responsive-match.component.css']
})
export class ResponsiveMatchComponent implements OnInit {
  faMinus = faMinus;
  faPlus = faPlus;
